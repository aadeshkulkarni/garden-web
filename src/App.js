...
function App() {
  ...
  return (
    ...
    >
      <div className={`z-10 container p-6`}>
        <Header />
        <GardenStats temperature={temperature} humidity={humid} />
        <div className="flex items-center justify-center w-full p-2 my-4 bg-gray-900 border border-gray-900 shadow-md h-28 shadow-gray-800 rounded-2xl">
          <Toggle
            id="water-status"
            title="Water status"
        ...
        >
          <img src={config.STREAM_URL} className="w-full h-full" />
        </Card>
        <Card
          cardTitle="Alarm"
